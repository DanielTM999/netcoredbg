...
//from corerror.h
        ...
        CASE_OF(CORPROF_E_MODULE_IS_ENC, " The module is EnC ");
        ...
        CASE_OF(CLR_E_BIND_ARCHITECTURE_MISMATCH, "The assembly architecture is not compatible with the current process architecture.");
